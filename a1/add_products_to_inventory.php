...
//loop through the 8 sets of fields on the initial form to process all of the products
        ...
        for ($x = 0; $x <= 7; $x++) {
            ...
            if (!empty($_POST['productname' . $x])) {
                ...
                $produceItem = ""; //added = "" to propery decalare a variable
                ...
                switch ($thisProduceType) {
                    ...
                    case "v": //veg
                        ...
                        $produceItem = new veggie($x, $thisProductName, $thisProductPriceType, $thisProductPrice); //removed _ to properly name variable
                        $typeType = "Veggie";
                        break;
                }

                if ($produceItem->price_type == 2) {
                    $pType = "Each"; //added semi-colon to terminate instruction
                } else {
                    $pType = "Per Lb";
                }
