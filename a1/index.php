    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="form-container">
                ...
                <form action="<?php echo URL_ROOT . '/add_products_to_inventory.php' ?>" method="post"> <!-- removed '' so URL_ROOT is no longer treated as a string -->
                    ...
                    for ($x = 0; $x <= 7; $x++) {
                        ...
                        <?php
                    } // end for loop replaced ) with } to properly close the for loop
                    ?>
